...
def extract_words(string):
    """Split string on spaces to get words. Tensor is padded with 
    tcl.constants.padding_token
    
    Args:
        string (Tensor): string to split
    
    Returns:
        Tensor: Dense tensor, filled with padding_token
    """
...
def extract_sents(string):
    """Split the document line into sentences, on `split_doc_token`
    which comes from tcl.constants.split_doc_token
    
    Args:
        string (Tensor): string to split
    
    Returns:
        Tensor: Dense Tensor of 1 more dimension than string
    """
...
def one_hot_label(string_label):
    ...
    Args:
        string_label (Tensor): string label to convert
    
    Returns:
        Tensor: tf.int64 Tensor of one-hot encoded labels. Has 1 more dimension than
            string_label
    """
...
def metric_variable(shape, dtype, validate_shape=True, name=None):
    ...
    from https://github.com/tensorflow/tensorflow/blob
        /r1.8/tensorflow/python/ops/metrics_impl.py
    """
